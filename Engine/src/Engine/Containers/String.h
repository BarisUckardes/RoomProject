...
namespace Engine
{
	...
	ENGINE_API String operator+(const String& target0, const String& target1);
	ENGINE_API bool operator==(const String& target0, const String& target1);
	ENGINE_API bool operator!=(const String& target0, const String& target1);
}